...
export default function SectionWrapper(props) {
    ...
    return (
        <section id={id} className="min-h-screen flex flex-col gap-10">
            <div className="bg-emerald-950 py-10 flex flex-col gap-2 justify-center items-center p-4">
            ...
            <div className="max-w-[900px] w-full flex flex-col mx-auto gap-12 p-4 ">
                {children}
            </div>
        </section>
    );
